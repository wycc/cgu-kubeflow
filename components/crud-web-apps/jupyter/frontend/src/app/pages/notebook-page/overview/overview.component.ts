...
export class OverviewComponent implements OnInit, OnDestroy {
  ...
  get proxyPortControl(): AbstractControl {
    return this.resourceForm.get('proxyPort') as AbstractControl;
  }
  ...
  private applyResourceValuesToNotebook(formValue: {
    ...
    if (formValue.proxyPort !== undefined) {
      if (!this.notebook.metadata.annotations) {
        this.notebook.metadata.annotations = {};
      }
      this.notebook.metadata.annotations['kflow.cgu.com.tw/proxy-ports'] = formValue.proxyPort;
    }
